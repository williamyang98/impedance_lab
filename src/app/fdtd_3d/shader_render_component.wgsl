...
const DATA_MODE_EX: i32 = 0;
const DATA_MODE_EY: i32 = 1;
const DATA_MODE_EZ: i32 = 2;
const DATA_MODE_HX: i32 = 3;
const DATA_MODE_HY: i32 = 4;
const DATA_MODE_HZ: i32 = 5;
override data_mode = DATA_MODE_EX;
